...
ENV JAVA_OPTS "-Xmx2048m -Xms1024m -Djava.awt.headless=true -Dfile.encoding=UTF-8 -Dclient.encoding.override=UTF-8 -Djava.net.preferIPv4Stack=true -server -XX:+HeapDumpOnOutOfMemoryError -XX:-PrintClassHistogram -XX:+PrintConcurrentLocks -XX:+PrintCommandLineFlags -XX:+PreserveFramePointer -XX:-CMSClassUnloadingEnabled -XX:CMSInitiatingOccupancyFraction=90 -XX:MaxHeapFreeRatio=90"
